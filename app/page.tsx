...
const logos = [
  ...
  { icon: <BrainCircuit className="h-8 w-8" />, name: "AWS Bedrock" },
  { icon: <Cpu className="h-8 w-8" />, name: "Claude LLM" },
  { icon: <Feather className="h-8 w-8" />, name: "Terraform" },
];
      ...
      <section className="mx-auto flex max-w-5xl flex-col items-center gap-6 py-8 md:py-12 lg:py-24">
        ...
        >
          <div className="flex flex-col items-center gap-6 text-center md:items-start md:text-left">
            ...
            >
              8 years. Production AI at enterprise scale. Three revenue-generating
              products shipped as a founder. Available US timezones.
            </motion.p>
            <motion.div
              variants={fadeIn}
              className="flex w-full flex-col items-center justify-center gap-4 sm:flex-row md:justify-start"
            >
